...
RESOURCES += src/qt/ionos.qrc src/qt/ionos_locale.qrc

TRANSLATIONS += src/qt/locale/ionos_bg.ts \
                src/qt/locale/ionos_de.ts \
                src/qt/locale/ionos_en.ts \
                src/qt/locale/ionos_es.ts \
                src/qt/locale/ionos_fi.ts \
                src/qt/locale/ionos_fr.ts \
                src/qt/locale/ionos_it.ts \
                src/qt/locale/ionos_ja.ts \
                src/qt/locale/ionos_pl.ts \
                src/qt/locale/ionos_pt.ts \
                src/qt/locale/ionos_ru.ts \
                src/qt/locale/ionos_sk.ts \
                src/qt/locale/ionos_sv.ts \
                src/qt/locale/ionos_vi.ts \
                src/qt/locale/ionos_zh_CN.ts \
                src/qt/locale/ionos_zh_TW.ts
