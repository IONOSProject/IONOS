                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Ionos Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ionos address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ionos: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zIOX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Ionos Core"), this);
    aboutAction->setStatusTip(tr("Show information about Ionos Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ionos"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ionos addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ionos addresses"));
    ...
    openAction->setStatusTip(tr("Open a Ionos: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Ionos Core help message to get a list with possible Ionos command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Ionos Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ionos network", "", count));
}
...
{
    QString strTitle = tr("Ionos Core"); // default title
...
/** Creates context menu, its actions, and ionoss up all the relevant signals for mouse events. */
