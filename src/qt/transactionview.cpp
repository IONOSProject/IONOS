                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Ionos from zIonos"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zIonos"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zIonos));
