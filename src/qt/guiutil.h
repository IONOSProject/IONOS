...
/** Utility functions used by the Ionos Qt UI.
 */
namespace GUIUtil
{
...
// Render Ionos addresses in monospace font
...
// Parse "ionos:" URI into recipient object, return true on successful parsing
