...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ionos features */
        {"ionos", "masternode", &masternode, true, true, false},
        {"ionos", "listmasternodes", &listmasternodes, true, true, false},
        {"ionos", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ionos", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ionos", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ionos", "masternodedebug", &masternodedebug, true, true, false},
        {"ionos", "startmasternode", &startmasternode, true, true, false},
        {"ionos", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ionos", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ionos", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ionos", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ionos", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ionos", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ionos", "mnbudget", &mnbudget, true, true, false},
        {"ionos", "preparebudget", &preparebudget, true, true, false},
        {"ionos", "submitbudget", &submitbudget, true, true, false},
        {"ionos", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ionos", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ionos", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ionos", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ionos", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ionos", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ionos", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ionos", "checkbudgets", &checkbudgets, true, true, false},
        {"ionos", "mnsync", &mnsync, true, true, false},
        {"ionos", "spork", &spork, true, true, false},
        {"ionos", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ionos", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ionosd, or the -server option to ionos-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ionos-cli " + methodname + " " + args + "\n";
}
