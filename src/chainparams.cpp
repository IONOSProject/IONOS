...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000007a39e6dda2d3b6abe3880b4b2b53366ea713ccc3bcf1ccc42a8acf585f7"));
		
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1538565240, // * UNIX timestamp of last checkpoint block - height=244799  log2_work=68.855275  tx=504525  date=2018-10-03 11:14:00 (GMT)
    504525,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 3600;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Ionos starting difficulty is 1 / 2^12
        ...
        nTargetSpacing = 1 * 30;  // Ionos: 30 Seconds
        nMaturity = 5;
        nMasternodeCountDrift = 20;
        nMaxMoneyOut = 10354937900 * COIN;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "JPMorgan (JPM) Q1 Earnings Beat on Better Rates and Trading  - Oct 15 2018 - Remapper";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1539856819;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 309133;
		
						
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000007a39e6dda2d3b6abe3880b4b2b53366ea713ccc3bcf1ccc42a8acf585f7"));
        assert(genesis.hashMerkleRoot == uint256("0xfb08331e07ccf9b3fd05eb4b16d84c8271efb73aa69b89b1a8deaacdd9fbc3d5"));

        vSeeds.push_back(CDNSSeedData("ionos.seeds.mn.zone", "ionos.seeds.mn.zone"));   // DNS SEEDER
		vSeeds.push_back(CDNSSeedData("ionos.mnseeds.com", "ionos.mnseeds.com"));       // DNS SEEDER
        ...
        strObfuscationPoolDummyAddress = "ieax8jHDQ1s2kHVjysEoTQncVdUrNBuXtp";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Ionos: 1 day
        nTargetSpacing = 1 * 60;  // Ionos: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet ionos addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet ionos script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet ionos BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet ionos BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet ionos BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Ionos: 1 day
        nTargetSpacing = 1 * 60;        // Ionos: 1 minutes
