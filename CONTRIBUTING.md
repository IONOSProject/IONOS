Contributing to Ionos Core
============================

The Ionos Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Ionos Core project, and is not to be
confused with overall Ionos Network Protocol consensus changes.

Whether a pull request is merged into Ionos Core rests with the project merge
...
Patches that change Ionos consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ionos consensus, it must have been
...
The project leader is the release manager for each Ionos Core release.
